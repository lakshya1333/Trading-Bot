...
export function Backpack({data}:{
    ...
    return <div className="min-w-[200px] bg-white rounded-lg shadow-md border border-gray-300 overflow-hidden cursor-move">
        <div className="bg-blue-600 px-3 py-2">
            <div className="text-white font-semibold text-sm">Backpack Trade</div>
        </div>
        ...
        <Handle type="source" position={Position.Right} className="!bg-blue-600 !w-3 !h-3"></Handle>
        <Handle type="target" position={Position.Left} className="!bg-blue-600 !w-3 !h-3"></Handle>
    </div>
}